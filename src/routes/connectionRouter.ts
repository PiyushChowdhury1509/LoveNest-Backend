...
connectionRouter.post('/send/:status/:userId',userAuth, async (req: Request,res: Response)=>{
    try{
        ...
        const existingRequest: connectionTypeWithId | null = await Connection.findOne({
            $or:[
